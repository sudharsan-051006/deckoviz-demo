        ...
        <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 text-center pt-16">
          ...
          <div className="mb-8">
            <h1 className="text-5xl md:text-5xl font-semibold text-gray-900 leading-tight">
              Deckoviz For Retail Stores,
              <br />
              Electronics Showrooms & Home
              <br />
              Décor Shops
            </h1>
          </div>
          ...
          <div className="mb-12 max-w-2xl">
            <p className="text-lg font-medium text-gray-900 leading-relaxed">
              Make Your Store a Living Experience. Attract
              <br />
              Attention. Drive Emotion. Inspire Purchases.
            </p>
          </div>
          ...
          <div className="max-w-4xl space-y-6 text-gray-900 font-medium leading-relaxed">
            ...
            <p className="text-base md:text-lg">
              ...
              <br />
              creativity, story, color, mood, emotion, and learning.
            </p>
 ...
 {/* ===== DYNAMIC IMAGE GRID ADDED HERE ===== */}
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
    ...
    <div className="relative group cursor-pointer">
      ...
      {/* Use Cases by Retail Environment Section */}
      <div className="bg-white relative py-24 md:py-24">
        <div className="relative z-10 max-w-7xl mx-auto px-4">
          {/* Header Section */}
      ...
      {/* Key Features Built for Retail Section */}
      <div className="bg-white relative py-24 md:py-24">
        <div className="relative z-10 max-w-7xl mx-auto px-4">
          {/* Header Section */}
          <div className="mb-16">
      ...
      {/* Sales Boost Opportunity Section */}
            ...
            <div className="text-left space-y-8">
              <div>
                <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 leading-tight mb-6">
                  Sales Boost Opportunity: Sell
                  <br />
                  Deckoviz as a Product Too
                </h2>
